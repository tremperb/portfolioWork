...
public:
    ...
    /**
     * Helper Function: Allows of to get the position
     * of the sellected successor function.
     * Once selected the values passed in will be
     * updated allowing the AI's move to be completed.
     */ 
    void get_move_position(int &holdRow, int &holdCol) {
        holdRow = this->row;
        holdCol = this->col;
    }
...
private:
    ...
    /** The Row where the AIs move will take place */
    int row;

    /** The Column where the AIs move will take place */
    int col;
